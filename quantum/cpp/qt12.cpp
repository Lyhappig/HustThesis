...
void qt12(int a[4], int b[4], int d[28]) {
    cx(a[2], d[6]);
    cx(a[0], d[6]);
    cx(b[2], d[7]);
    cx(b[0], d[7]);
...
void qt12_1(int a[4], int b[4], int d[28]) {
    cx(a[0], d[6]);
    cx(a[2], d[6]);
    cx(b[0], d[7]);
    cx(b[2], d[7]);
    ...
    QAND(a[0], b[0], d[15], d[20]);
    QAND(a[1], b[1], d[16], d[21]);
    QAND(a[2], b[2], d[17], d[22]);
    QAND(a[3], b[3], d[18], d[23]);
    cx(d[17], d[0]);
    cx(d[16], d[0]);
    cx(d[15], d[0]);
    cx(d[18], d[1]);
